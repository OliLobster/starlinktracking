...
class Main extends Component {
    ...
    trackOnClick = (duration) => {
        ...
        const urls = this.state.selected.map( sat => {
            const { satid } = sat;
            const url = `/apc/${satid}/${observerLat}/${observerLong}/${observerAlt}/${endTime}/&apiKey=${SAT_API_KEY}`;
    ...
    fetchSatellite = (setting) => {
        ...
        const url = `/api/${observerLat}/${observerLong}/${observerAlt}/${radius}/${STARLINK_CATEGORY}/&apiKey=${SAT_API_KEY}`;
    ...
    track = () => {
        ...
        let timer = setInterval( () => {
            ...
            context2.clearRect(0, 0, width, height);// erase previous canvas
